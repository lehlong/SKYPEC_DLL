...
{
    public class SAPMdGLAccountService : GenericService<T_SAP_MD_GLACCOUNT, SAPMdGLAccountRepo>
    {
        public SAPMdGLAccountService() : base()
        {
