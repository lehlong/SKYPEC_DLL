...
{
    public class RevenuePLReviewCommentService : GenericService<T_BP_REVENUE_PL_REVIEW_COMMENT, RevenuePLReviewCommentRepo>
    {
        internal void GetHeader(string orgCode, string elementCode, int year, int version, string onOrgCode)
        {
            var header = GetFirstByExpression(
                        x => x.REVENUE_PL_ELEMENT_CODE == elementCode &&
                        x.ORG_CODE == orgCode &&
            ...
            if (header == null)
            {
                ...
                ObjDetail.REVENUE_PL_ELEMENT_CODE = elementCode;
        ...
        internal void GetComments()
        {
            ...
            query = query
                ...
                .Where(x => x.REVENUE_PL_ELEMENT_CODE == ObjDetail.REVENUE_PL_ELEMENT_CODE)
        ...
        public override void Create()
        {
            try
            {
                ...
                var header = new T_BP_REVENUE_PL_REVIEW_COMMENT();
        ...
        {
            return SelectListUtilities.GetChildElement<T_MD_REVENUE_PL_ELEMENT, RevenuePLElementRepo>(year);
        }
        ...
        internal IList<string> GetUsersComment(int year, int? version, string elementCode, string centerCode)
        {
            ...
            {
                query = query.Where(x => x.REVENUE_PL_ELEMENT_CODE == elementCode);
            }
