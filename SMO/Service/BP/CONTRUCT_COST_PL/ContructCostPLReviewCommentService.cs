...
{
    public class ContructCostPLReviewCommentService : GenericService<T_BP_CONTRUCT_COST_PL_REVIEW_COMMENT, ContructCostPLReviewCommentRepo>
    {
        ...
        public override void Create()
        {
            try
            {
                ...
                var header = new T_BP_CONTRUCT_COST_PL_REVIEW_COMMENT();
