...
{
    public class OtherCostCFReviewCommentService : GenericService<T_BP_OTHER_COST_CF_REVIEW_COMMENT, OtherCostCFReviewCommentRepo>
    {
        ...
        public override void Create()
        {
            try
            {
                ...
                var header = new T_BP_OTHER_COST_CF_REVIEW_COMMENT();
        ...
        internal IList<string> GetUsersComment(int year, int? version, string elementCode, string centerCode)
        {
            ...
            {
                query = query.Where(x => x.COST_CF_ELEMENT_CODE == elementCode);
            }
