    ...
    <form id="form1" runat="server">
        ...
        <div>
            <iz:FileManager ID="FileManager1" runat="server" Height="480" Width="570" ImagesFolder="~/FileBrowser/img/cmd"
                MainDirectory="~/UploadImageNews" CustomThumbnailHandler="~/FileBrowser/IZWebFileManagerThumbnailHandler.ashx"
                ...
                callbacks: {
                    ...
                    onComplete: function (id, fileName, responseJSON) {
                        if (responseJSON.success) {
                            ...
                            bootbox.alert('Có lỗi xẩy ra: ' + responseJSON.msg);
                        }
                        $fileview.spin(false);
                    }
                }
