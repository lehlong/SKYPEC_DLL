...
{
    public class OtherCostCFReviewCommentController : Controller
    {
        private readonly OtherCostCFReviewCommentService _service;

        public OtherCostCFReviewCommentController()
        {
            _service = new OtherCostCFReviewCommentService();
        }
        ...
        public ActionResult List(OtherCostCFReviewCommentService service)
        {
            service.GetComments();
            return PartialView("../Comment/ListOtherCostCF", service.ObjList);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult Comment(OtherCostCFReviewCommentService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult CommentDataCenter(OtherCostCFReviewCommentService service)
        {
            var result = new TransferObject
            {
                Type = TransferType.AlertSuccessAndJsCommand
