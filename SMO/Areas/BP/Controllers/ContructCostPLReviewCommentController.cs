...
{
    public class ContructCostPLReviewCommentController : Controller
    {
        private readonly ContructCostPLReviewCommentService _service;

        public ContructCostPLReviewCommentController()
        {
            _service = new ContructCostPLReviewCommentService();
        }
        ...
        public ActionResult List(ContructCostPLReviewCommentService service)
        {
            service.GetComments();
            return PartialView("../Comment/ListContructCostPL", service.ObjList);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult Comment(ContructCostPLReviewCommentService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public JsonResult CommentDataCenter(ContructCostPLReviewCommentService service)
        {
            var result = new TransferObject
            {
                Type = TransferType.AlertSuccessAndJsCommand
