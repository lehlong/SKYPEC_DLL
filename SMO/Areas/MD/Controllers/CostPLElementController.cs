...
{
    public class CostPLElementController : Controller
    {
        private readonly CostPLElementService _service;
        public CostPLElementController()
        {
            _service = new CostPLElementService();
        }
        // GET: MD/CostElement
        [AuthorizeCustom(Right = "R211")]
        ...
        public ActionResult Create(CostPLElementService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(CostPLElementService service)
        {
            var result = new TransferObject
            {
                Type = TransferType.AlertSuccessAndJsCommand
