...
{
    public class RevenueCFElementController : Controller
    {
        private readonly RevenueCFElementService _service;
        public RevenueCFElementController()
        {
            _service = new RevenueCFElementService();
        }
        // GET: MD/CostElement
        [AuthorizeCustom(Right = "R214")]
        ...
        public ActionResult Create(RevenueCFElementService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(RevenueCFElementService service)
        {
            var result = new TransferObject
            {
                Type = TransferType.AlertSuccessAndJsCommand
