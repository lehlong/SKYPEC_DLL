...
{
    public class RevenuePLElementController : Controller
    {
        private readonly RevenuePLElementService _service;
        public RevenuePLElementController()
        {
            _service = new RevenuePLElementService();
        }
        // GET: MD/CostElement
        [AuthorizeCustom(Right = "R213")]
        ...
        public ActionResult Create(RevenuePLElementService service)
        {
        ...
        [AuthorizeCustom(Right = "R213")]
        [ValidateAntiForgeryToken]
        public ActionResult Update(RevenuePLElementService service)
        {
            var result = new TransferObject
            {
                Type = TransferType.AlertSuccessAndJsCommand
