...
namespace SMO.Areas.AD.Controllers
{
    ...
    public class ConnectionController : Controller
    {
        ...
        public ActionResult List(ConnectionService service)
        {
            service.GetAll();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create(ConnectionService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(ConnectionService service)
        {
            var result = new TransferObject
            {
                Type = TransferType.AlertSuccessAndJsCommand
