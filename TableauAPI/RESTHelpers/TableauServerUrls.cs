...
namespace TableauAPI.RESTHelpers
{
    ...
    public class TableauServerUrls : ITableauServerSiteInfo
    {
        ...
        public TableauServerUrls(ServerProtocol protocol, string serverName, string siteName, int pageSize = 1000, ServerVersion serverVersion = ServerVersion.Server9, string apiVersion = "3.5")
        {
            PageSize = 1000;
        ...
        private static ServerProtocol _GetProtocolFromUrl(string url)
        {
            ...
            string protocol = url.Substring(0, idxProtocol);
