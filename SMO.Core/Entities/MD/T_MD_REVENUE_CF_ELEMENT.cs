...
namespace SMO.Core.Entities.MD
{
    ...
    public class T_MD_REVENUE_CF_ELEMENT : CoreElement, ICloneable
    {
        public T_MD_REVENUE_CF_ELEMENT() : base()
        {
        ...
        {
            return obj is T_MD_REVENUE_CF_ELEMENT element &&
        ...
        public static explicit operator T_MD_REVENUE_CF_ELEMENT(T_BP_REVENUE_CF_DATA_HISTORY v)
        {
            if (v == null)
            {
                return new T_MD_REVENUE_CF_ELEMENT();
            }
        ...
        public static explicit operator T_MD_REVENUE_CF_ELEMENT(T_BP_REVENUE_CF_DATA v)
        {
            if (v == null)
            {
                return new T_MD_REVENUE_CF_ELEMENT();
        ...
        public static explicit operator T_MD_REVENUE_CF_ELEMENT(T_BP_REVENUE_CF_DATA_BASE v)
        {
            return new T_MD_REVENUE_CF_ELEMENT
            {
        ...
        public static explicit operator T_MD_REVENUE_CF_ELEMENT(T_BP_REVENUE_CF_DATA_BASE_HISTORY v)
        {
            return new T_MD_REVENUE_CF_ELEMENT
            {
                ORG_NAME = $"{v.MATERIAL} ({v.UNIT})",
