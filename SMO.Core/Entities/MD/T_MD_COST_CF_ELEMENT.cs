...
{
    public class T_MD_COST_CF_ELEMENT : CoreElement, ICloneable
    {
        public T_MD_COST_CF_ELEMENT() : base()
        {
        ...
        {
            return obj is T_MD_COST_CF_ELEMENT element &&
        ...
        public static explicit operator T_MD_COST_CF_ELEMENT(T_BP_COST_CF_DATA_HISTORY v)
        {
            if (v == null)
            {
                return new T_MD_COST_CF_ELEMENT();
            }
            return new T_MD_COST_CF_ELEMENT
            {
        ...
        public static explicit operator T_MD_COST_CF_ELEMENT(T_BP_COST_CF_DATA v)
        {
            if (v == null)
            {
                return new T_MD_COST_CF_ELEMENT();
        ...
        public static explicit operator T_MD_COST_CF_ELEMENT(T_BP_CONTRUCT_COST_CF_DATA_HISTORY v)
        {
            if (v == null)
            {
                return new T_MD_COST_CF_ELEMENT();
        ...
        public static explicit operator T_MD_COST_CF_ELEMENT(T_BP_CONTRUCT_COST_CF_DATA v)
        {
            if (v == null)
            {
                return new T_MD_COST_CF_ELEMENT();
        ...
        public static explicit operator T_MD_COST_CF_ELEMENT(T_BP_OTHER_COST_CF_DATA_HISTORY v)
        {
            if (v == null)
            {
                return new T_MD_COST_CF_ELEMENT();
        ...
        public static explicit operator T_MD_COST_CF_ELEMENT(T_BP_OTHER_COST_CF_DATA v)
        {
            if (v == null)
            {
                return new T_MD_COST_CF_ELEMENT();
        ...
        public static explicit operator T_MD_COST_CF_ELEMENT(T_BP_COST_CF_DATA_BASE v)
        {
            return new T_MD_COST_CF_ELEMENT
            {
        ...
        public static explicit operator T_MD_COST_CF_ELEMENT(T_BP_COST_CF_DATA_BASE_HISTORY v)
        {
            return new T_MD_COST_CF_ELEMENT
            {
                ORG_NAME = $"{v.MATERIAL} ({v.UNIT})",
        ...
        public static explicit operator T_MD_COST_CF_ELEMENT(T_BP_OTHER_COST_CF_DATA_BASE v)
        {
            return new T_MD_COST_CF_ELEMENT
            {
                ORG_NAME = $"{v.MATERIAL} ({v.UNIT})",
        ...
        public static explicit operator T_MD_COST_CF_ELEMENT(T_BP_OTHER_COST_CF_DATA_BASE_HISTORY v)
        {
            return new T_MD_COST_CF_ELEMENT
            {
                ORG_NAME = $"{v.MATERIAL} ({v.UNIT})",
        ...
        public static explicit operator T_MD_COST_CF_ELEMENT(T_BP_CONTRUCT_COST_CF_DATA_BASE v)
        {
            return new T_MD_COST_CF_ELEMENT
            {
                ORG_NAME = $"{v.MATERIAL} ({v.UNIT})",
        ...
        public static explicit operator T_MD_COST_CF_ELEMENT(T_BP_CONTRUCT_COST_CF_DATA_BASE_HISTORY v)
        {
            return new T_MD_COST_CF_ELEMENT
            {
                ORG_NAME = $"{v.MATERIAL} ({v.UNIT})",
