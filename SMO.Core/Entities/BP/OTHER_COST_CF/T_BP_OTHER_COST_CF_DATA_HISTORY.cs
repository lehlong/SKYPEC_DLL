...
{
    public partial class T_BP_OTHER_COST_CF_DATA_HISTORY : BaseEntity
    {
        ...
        public static explicit operator T_BP_OTHER_COST_CF_DATA(T_BP_OTHER_COST_CF_DATA_HISTORY history)
        {
            return new T_BP_OTHER_COST_CF_DATA
            {
                PKID = history.PKID,
                ORG_CODE = history.ORG_CODE,
                OTHER_PROFIT_CENTER_CODE = history.OTHER_PROFIT_CENTER_CODE,
                ...
                OtherProfitCenter = history.OtherProfitCenter,
        ...
        public static implicit operator T_BP_OTHER_COST_CF_DATA_HISTORY(T_BP_OTHER_COST_CF_DATA data)
        {
            return new T_BP_OTHER_COST_CF_DATA_HISTORY
            {
                PKID = data.PKID,
                ORG_CODE = data.ORG_CODE,
                OTHER_PROFIT_CENTER_CODE = data.OTHER_PROFIT_CENTER_CODE,
                TEMPLATE_CODE = data.TEMPLATE_CODE,
                COST_CF_ELEMENT_CODE = data.COST_CF_ELEMENT_CODE,
                ...
                OtherProfitCenter = data.OtherProfitCenter,
                STATUS = data.STATUS,
