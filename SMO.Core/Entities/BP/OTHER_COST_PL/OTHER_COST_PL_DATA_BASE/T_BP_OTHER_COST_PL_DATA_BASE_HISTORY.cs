...
namespace SMO.Core.Entities.BP.OTHER_COST_PL.OTHER_COST_PL_DATA_BASE
{
    public class T_BP_OTHER_COST_PL_DATA_BASE_HISTORY : BaseEntity
    {
        ...
        public static explicit operator T_BP_OTHER_COST_PL_DATA_BASE_HISTORY(T_BP_OTHER_COST_PL_DATA_BASE v)
        {
            return new T_BP_OTHER_COST_PL_DATA_BASE_HISTORY
            {
                PKID = v.PKID,
                ORG_CODE = v.ORG_CODE,
                COMPANY_CODE = v.COMPANY_CODE,
                PROJECT_CODE = v.PROJECT_CODE,
                OTHER_PROFIT_CENTER_CODE = v.OTHER_PROFIT_CENTER_CODE,
