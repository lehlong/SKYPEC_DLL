...
namespace SMO.Core.Entities.BP.REVENUE_CF.REVENUE_CF_DATA_BASE
{
    public class T_BP_REVENUE_CF_DATA_BASE_HISTORY : BaseEntity
    {
        ...
        public static explicit operator T_BP_REVENUE_CF_DATA_BASE_HISTORY(T_BP_REVENUE_CF_DATA_BASE v)
        {
            return new T_BP_REVENUE_CF_DATA_BASE_HISTORY
            {
                PKID = v.PKID,
                ORG_CODE = v.ORG_CODE,
                ...
                REVENUE_CF_ELEMENT_CODE = v.REVENUE_CF_ELEMENT_CODE,
                VERSION = v.VERSION,
