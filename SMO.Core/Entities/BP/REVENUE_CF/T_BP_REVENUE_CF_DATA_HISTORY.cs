...
{
    public partial class T_BP_REVENUE_CF_DATA_HISTORY : BaseEntity
    {
        ...
        public static explicit operator T_BP_REVENUE_CF_DATA(T_BP_REVENUE_CF_DATA_HISTORY history)
        {
            return new T_BP_REVENUE_CF_DATA
            {
                PKID = history.PKID,
                ORG_CODE = history.ORG_CODE,
                PROFIT_CENTER_CODE = history.PROFIT_CENTER_CODE,
                TEMPLATE_CODE = history.TEMPLATE_CODE,
                REVENUE_CF_ELEMENT_CODE = history.REVENUE_CF_ELEMENT_CODE,
        ...
        public static implicit operator T_BP_REVENUE_CF_DATA_HISTORY(T_BP_REVENUE_CF_DATA data)
        {
            return new T_BP_REVENUE_CF_DATA_HISTORY
            {
                PKID = data.PKID,
                ORG_CODE = data.ORG_CODE,
                PROFIT_CENTER_CODE = data.PROFIT_CENTER_CODE,
                TEMPLATE_CODE = data.TEMPLATE_CODE,
                REVENUE_CF_ELEMENT_CODE = data.REVENUE_CF_ELEMENT_CODE,
