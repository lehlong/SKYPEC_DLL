...
namespace SMO.Core.Entities.BP.CONTRUCT_COST_PL.CONTRUCT_COST_PL_DATA_BASE
{
    public class T_BP_CONTRUCT_COST_PL_DATA_BASE_HISTORY : BaseEntity
    {
        ...
        public static explicit operator T_BP_CONTRUCT_COST_PL_DATA_BASE_HISTORY(T_BP_CONTRUCT_COST_PL_DATA_BASE v)
        {
            return new T_BP_CONTRUCT_COST_PL_DATA_BASE_HISTORY
            {
                PKID = v.PKID,
                ORG_CODE = v.ORG_CODE,
                INTERNAL_ORDER_CODE = v.INTERNAL_ORDER_CODE,
                TEMPLATE_CODE = v.TEMPLATE_CODE,
                COST_PL_ELEMENT_CODE = v.COST_PL_ELEMENT_CODE,
                VERSION = v.VERSION,
