...
namespace SMO.Core.Entities.BP.REVENUE_PL.REVENUE_PL_DATA_BASE
{
    public class T_BP_REVENUE_PL_DATA_BASE_HISTORY : BaseEntity
    {
        ...
        public static explicit operator T_BP_REVENUE_PL_DATA_BASE_HISTORY(T_BP_REVENUE_PL_DATA_BASE v)
        {
            return new T_BP_REVENUE_PL_DATA_BASE_HISTORY
            {
                PKID = v.PKID,
                ORG_CODE = v.ORG_CODE,
                COMPANY_CODE = v.COMPANY_CODE,
                PROJECT_CODE = v.PROJECT_CODE,
                PROFIT_CENTER_CODE = v.PROFIT_CENTER_CODE,
                TEMPLATE_CODE = v.TEMPLATE_CODE,
                REVENUE_PL_ELEMENT_CODE = v.REVENUE_PL_ELEMENT_CODE,
                VERSION = v.VERSION,
