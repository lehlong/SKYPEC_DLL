...
{
    public class OtherCostCFRepo : GenericBPRepository<T_BP_OTHER_COST_CF>, IOtherCostCFRepo
    {
        public OtherCostCFRepo(NHUnitOfWork unitOfWork) : base(unitOfWork)
        {

        }

        public override IList<T_BP_OTHER_COST_CF> Search(T_BP_OTHER_COST_CF objFilter, int pageSize, int pageIndex, out int total)
        {
            var query = NHibernateSession.QueryOver<T_BP_OTHER_COST_CF>();
