...
namespace SMO.Repository.Mapping.BP.CONTRUCT_COST_PL.CONTRUCT_COST_PL_DATA_BASE
{
    public class T_BP_CONTRUCT_COST_PL_DATA_BASE_HISTORY_Mapping : BaseMapping<T_BP_CONTRUCT_COST_PL_DATA_BASE_HISTORY>
    {
        public T_BP_CONTRUCT_COST_PL_DATA_BASE_HISTORY_Mapping()
        {
            Id(x => x.PKID);
