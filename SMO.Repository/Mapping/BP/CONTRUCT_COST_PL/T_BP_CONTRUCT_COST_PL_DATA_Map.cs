...
{
    public class T_BP_CONTRUCT_COST_PL_DATA_Map : BaseMapping<T_BP_CONTRUCT_COST_PL_DATA>
    {
        public T_BP_CONTRUCT_COST_PL_DATA_Map()
        {
            Table("T_BP_CONTRUCT_COST_PL_DATA");
            Id(x => x.PKID);
            Map(x => x.ORG_CODE);
