...
namespace SMO.Repository.Mapping.BP.COST_CF.COST_CF_DATA_BASE
{
    public class T_BP_COST_CF_DATA_BASE_HISTORY_Mapping : BaseMapping<T_BP_COST_CF_DATA_BASE_HISTORY>
    {
        public T_BP_COST_CF_DATA_BASE_HISTORY_Mapping()
        {
            Id(x => x.PKID);
