...
namespace SMO.Repository.Mapping.BP.REVENUE_PL.REVENUE_PL_DATA_BASE
{
    public class T_BP_REVENUE_PL_DATA_BASE_HISTORY_Mapping : BaseMapping<T_BP_REVENUE_PL_DATA_BASE_HISTORY>
    {
        public T_BP_REVENUE_PL_DATA_BASE_HISTORY_Mapping()
        {
            Id(x => x.PKID);
