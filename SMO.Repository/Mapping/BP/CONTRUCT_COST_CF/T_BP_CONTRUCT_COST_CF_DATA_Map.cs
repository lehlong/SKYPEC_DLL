...
{
    public class T_BP_CONTRUCT_COST_CF_DATA_Map : BaseMapping<T_BP_CONTRUCT_COST_CF_DATA>
    {
        public T_BP_CONTRUCT_COST_CF_DATA_Map()
        {
            Table("T_BP_CONTRUCT_COST_CF_DATA");
            Id(x => x.PKID);
            Map(x => x.ORG_CODE);
